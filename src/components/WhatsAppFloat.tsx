...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="whatsapp-float fixed right-[max(1.25rem,env(safe-area-inset-right))] bottom-[max(1.25rem,env(safe-area-inset-bottom))] z-50 inline-flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/40 transition hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white/60"
    >
